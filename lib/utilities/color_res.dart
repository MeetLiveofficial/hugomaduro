...
/// Meet&Live — paleta Warm Sunrise + Dusk Violet (board oficial).
///
/// Warm Sunrise: Soft Salmon #FFA07A · Coral Red #FF6347
/// Dusk Violet: Mauve #BA55D3 · #9966CC · #7851A9
/// Acentos: #FF8FA3 · #FFCC99
class ColorRes {
  static const Color blackPure = Color(0xFF000000);
  static const Color whitePure = Color(0xFFFFFFFF);

  // ── Board ──────────────────────────────────────────────────────
  static const Color softSalmon = Color(0xFFFFA07A);
  static const Color coralRed = Color(0xFFFF6347);
  static const Color mauve = Color(0xFFBA55D3);
  static const Color accentRose = Color(0xFFFF8FA3);
  static const Color accentPeach = Color(0xFFFFCC99);
  static const Color mediumPurple = Color(0xFF9966CC);
  static const Color darkPurple = Color(0xFF7851A9);

  static const Color brandCoral = coralRed;
  static const Color brandPink = accentRose;
  static const Color brandMagenta = mauve;
  ...
  static const Color baseCream = Color(0xFFFFE8D6);
  ...
  /// Warm Sunrise (principal). Sin plum oscuro al final.
  static const Color themeGradient1 = softSalmon;
  static const Color themeGradientMid = coralRed;
  static const Color themeGradient2 = coralRed;

  static const Color clientGradient1 = mauve;
  static const Color clientGradientMid = mediumPurple;
  static const Color clientGradient2 = darkPurple;

  static const Color themeAccentSolid = coralRed;

  static const Color themeColor = bgVoid;
  static const Color obsidianNavy = bgVoid;
  static const Color surfaceDeep = bgElevated;

  static const Color textDarkGrey = Color(0xFF1C1C22);
  static const Color textLightGrey = Color(0xFF5C5C68);
  ...
  static const Color bgLightGrey = Color(0xFFFFF6F2);
  static const Color bgGrey = Color(0xFFF3E9E4);
  static const Color bgMediumGrey = Color(0xFFFAF0EC);
  static const Color disabledGrey = Color(0xFFB8AFA8);
}
