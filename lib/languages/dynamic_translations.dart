...
const _liveEs = <String, String>{
  ...
  LKey.boostGiftsHint:
      'Elige un regalo o invita a regalar en general.',
  LKey.chooseGift: 'Elegir regalo',
...
const _livePt = <String, String>{
  ...
  LKey.boostGiftsHint:
      'Escolha um presente ou convide todos a presentear.',
  LKey.chooseGift: 'Escolher presente',
...
const _liveAr = <String, String>{
  ...
  LKey.boostGiftsHint: 'اختر هدية للطلب، أو ادعُ الجميع لإرسال الهدايا.',
  LKey.chooseGift: 'اختر هدية',
...
const _liveRu = <String, String>{
  ...
  LKey.boostGiftsHint:
      'Выберите подарок для запроса или пригласите всех дарить.',
  LKey.chooseGift: 'Выбрать подарок',
...
const _liveUk = <String, String>{
  ...
  LKey.boostGiftsHint:
      'Оберіть подарунок для запиту або запросіть усіх дарувати.',
  LKey.chooseGift: 'Обрати подарунок',
...
const _liveZh = <String, String>{
  ...
  LKey.boostGiftsHint: '选择礼物来请求，或邀请大家送礼。',
  LKey.chooseGift: '选择礼物',
