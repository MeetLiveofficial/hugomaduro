    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          // Perfil ajeno: menÃº â‹¯ (follow / report / block).
          if (!isMe)
            IconButton(
              onPressed: () =>
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Elige foto de perfil o publica un post desde tu galerÃ­a',
              style: TextStyleCustom.outFitRegular400(
            ...
            _AddMediaOption(
              ...
              subtitle: 'Cambiar tu foto de perfil desde la galerÃ­a',
              onTap: () {
                Get.back();
            ...
            _AddMediaOption(
              ...
              title: 'Publicar post',
              subtitle: 'Subir una o mÃ¡s fotos como publicaciÃ³n',
              onTap: () {
                Get.back();
...
class _ImpressionCard extends StatelessWidget {
  ...
  Future<void> _openRateSheet(BuildContext context) async {
    ...
    await ImpressionRateSheet.show(
