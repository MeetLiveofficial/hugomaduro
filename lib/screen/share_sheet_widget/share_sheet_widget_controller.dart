...
import 'package:krimson/common/manager/screenshot_manager.dart';
...
import 'package:krimson/screen/share_sheet_widget/widget/more_user_sheet.dart';
...
class ShareSheetWidgetController extends BaseController {
  ...
  void onShareSheetBottomBtnTap(ShareOption type, String link,
      {Post? post}) async {
    if (type == ShareOption.download) {
      if (!ContentProtection.ensureDownloadAllowed()) return;
    } else if (!ContentProtection.ensureShareAllowed()) {
      return;
    }
