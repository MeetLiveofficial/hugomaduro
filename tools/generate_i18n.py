...
ES_MISSING: dict[str, str] = {
    ...
    "matchTopRated": "La mejor valorada",
    "unBlock": "Desbloquear",
    "myLevel": "Mi nivel",
    "recharge": "Recargar",
    "equip": "Equipar",
    ...
    "likeThem": "¿Te gusta?",
    "rechargeAndCallAgain": "¡Recarga y vuelve a llamar!",
    "beginnerDiscount": "Descuento para principiantes",
    ...
    "refreshLiveConnection": "Refrescar conexión",
    "enablingCamera": "Activando cámara…",
    "waitingForClient": "Esperando cliente…",
    "waitingMatchConnection": "Esperando conexión con un usuario para iniciar el Match",
...
PT_MISSING: dict[str, str] = {
    ...
    "matchTopRated": "A melhor avaliada",
    "unBlock": "Desbloquear",
    "myLevel": "Meu nível",
    "recharge": "Recarregar",
    "equip": "Equipar",
    ...
    "likeThem": "Gostou?",
    "rechargeAndCallAgain": "Recarregue e ligue de novo!",
    "beginnerDiscount": "Desconto para iniciantes",
    ...
    "refreshLiveConnection": "Atualizar conexão",
    "enablingCamera": "Ativando câmera…",
    "waitingForClient": "Aguardando cliente…",
    "waitingMatchConnection": "Aguardando conexão com um usuário para iniciar o Match",
